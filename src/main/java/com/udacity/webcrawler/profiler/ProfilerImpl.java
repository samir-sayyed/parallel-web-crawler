...
//      System.out.println("heeeeeeeeeeeeeeeee");
      throw new IllegalArgumentException("Class dose not annotated with Profiled method");
    }
//    System.out.println("Hiiiiiiiiiii");
    InvocationHandler invocationHandler = new ProfilingMethodInterceptor(clock, delegate, state);

    Object proxy = Proxy.newProxyInstance(ProfilerImpl.class.getClassLoader(), new Class[]{klass},invocationHandler);
...
//    System.out.println("inside writedata helper");
    state.write(writer);
  }
}
